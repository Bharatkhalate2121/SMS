...
<body style="background: rgb(164,237,238);
background: radial-gradient(circle, rgba(164,237,238,1) 0%, rgba(255,255,255,1) 85%);">
<?php
include "nav.php";
if ($user_dd==0) {
...
echo '<h3 align="center"style="margin: 10px 4px;
">Class : '.$class_name.'</h3>';
?>
<div style="display:flex;flex-direction:row;">
<div style="width:50vw">
<img src="sms_image.png" alt=""style="width:50vw;height:100vh">

</div>
<div style="display:flex;flex-direction:column;float:right;width:50vw">
<div class="container rounded bg-dark my-2 text-white px-3" style="height: 540px;overflow-x: hidden;overflow-y: auto;padding: 16px 16px;" id="show">
<?php
// echo $tid; 
?>
</div>
